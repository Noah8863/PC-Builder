...
function Home() {
  ...
  return (
    <main className="w-5/6 m-auto justify-center bg-gray-400 h-contain">
      <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 xl:grid-cols-7 gap-3">
        {Object.entries(partCategorie).map(([category, prefixes]) => {
          ...
          return (
            <div
              key={category}
              className="grid p-6 bg-blue-300 m-4 items-center text-center text-xl justify-center rounded-lg p-4"
            >
      ...
      <div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 m-4 p-4">
          <button className="flex flex-col items-center justify-center bg-blue-500 text-white rounded-lg p-4">
